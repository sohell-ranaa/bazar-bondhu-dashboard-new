(function ($) {
    $.fn.WimmViewer = function (options) {
        ...
        $(self).prepend('<div class="mainImg ratio-1-1"><div class="ratio-inner bigImg"></div></div>');

        var mainPicture = $(self).find('.bigImg');
        ...
        $(mainPicture).css('background-image','url('+ firstImageUrl +')');
        ...
        $(self).find('.item').each(function () {
            $(this).click(function () {
                ...
                $(mainPicture).css('background-image','url('+ imageUrl +')');
