...
var Dashboard = function () {
    ...
    var quickStats = function () {
        ...
        _initSparklineChart($('#m_chart_quick_stats_1'), allSales, mUtil.getColor('brand'), 1);
        _initSparklineChart($('#m_chart_quick_stats_2'), todaysOrders, mUtil.getColor('danger'), 1);
        _initSparklineChart($('#m_chart_quick_stats_3'), udcCommission, mUtil.getColor('success'), 1);
        _initSparklineChart($('#m_chart_quick_stats_4'), averageOrders, mUtil.getColor('accent'), 1);
    }
