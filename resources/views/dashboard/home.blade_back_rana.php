...
@section('content')
            ...
            <div class="card-body-top-part">
                <div class="d-flex">
                    ...
                    <div class="info-card" style="margin-right: 30px">
                        ...
                        <span class="info-value">{{@$tangail_order_count + @$sirajganj_order_count + @$jamalpur_order_count + @$sherpur_order_count}}</span>
                    </div>
                    <div class="info-card" style="margin-right: 30px">
                        <h4 class="info-title">Total Amount</h4>
                        <span class="info-value">{{@$tangail_sales_count +@$sirajganj_sales_count +@$jamalpur_sales_count +@$sherpur_sales_count}}</span>
                    </div>
                    <div class="info-card">
    ...
    <div class="block-card">
        ...
        <div class="block-body">
            ...
            <!--Commented by Rana | From here-->

    <!--<div class="row">-->
    <!--    <div class="col-lg-3 col-md-6">-->
    <!--        <div class="block-card">-->
    <!--            <div class="block-body">-->
    <!--                <img src="{{asset('public/assets')}}/img/m1-update.png" alt="" class="img-responsive">-->
    <!--            </div>-->
    <!--        </div>-->
    <!--    </div>-->
    ...
    <!--        <div class="block-card">-->
    <!--            <div class="block-body">-->
    <!--                <img src="{{asset('public/assets')}}/img/m2-update.png" alt="" class="img-responsive">-->
    <!--            </div>-->
    <!--        </div>-->
    <!--    </div>-->
    ...
    <!--        <div class="block-card">-->
    <!--            <div class="block-body">-->
    <!--                <img src="{{asset('public/assets')}}/img/m3-update.png" alt="" class="img-responsive">-->
    <!--            </div>-->
    <!--        </div>-->
    <!--    </div>-->
    ...
    <!--        <div class="block-card">-->
    <!--            <div class="block-body">-->
    <!--                <img src="{{asset('public/assets')}}/img/m4-update.png" alt="" class="img-responsive">-->
    <!--            </div>-->
    <!--        </div>-->
    <!--            </div>-->
    <!--</div>-->

    <!--Commented by Rana | To here-->
